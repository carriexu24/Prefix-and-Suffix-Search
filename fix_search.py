...
def control(args, words):
    ...
    if not set(args.fix).issubset(string.ascii_uppercase + string.ascii_lowercase):
        return parser.print_help()
...
if __name__ == "__main__":
    ...
    parser.add_argument('fix', type=str, help='''
        ...
        ''')
    parser.add_argument('-p', '--prefix', action='store_true', dest='p', default=False, help='prefix search')
    parser.add_argument('-s', '--suffix', action='store_true', dest='s', default=False, help='suffix search')
